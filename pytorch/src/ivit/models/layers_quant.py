...
def trunc_normal_(tensor, mean=0.0, std=1.0, a=-2.0, b=2.0):
    #print("DEBUG: trunc_normal_ drop_path")
...
class Mlp(nn.Module):
    ...
    def forward(self, x, act_scaling_factor, blk_id=0):
        ...
        #print(x.shape) # torch.Size([8, 197, 192])
        #exit(0)
        x, act_scaling_factor = self.fc1(x, act_scaling_factor, fl.att_blocks_flist_map[4][blk_id])
        ...
        x, act_scaling_factor = self.fc2(x, act_scaling_factor, fl.att_blocks_flist_map[5][blk_id])
