...
module PE_1024(
  ...
  wire [31:0] _mac_unit_io_out_d;	// @[PE.scala:64:24]
  ...
  always @(posedge clock) begin
    if (io_in_valid) begin
      if (io_in_control_propagate) begin
        ...
        c2 <= _mac_unit_io_out_d;	// @[PE.scala:64:24, :70:15]
      end
      else begin
        c1 <= _mac_unit_io_out_d;	// @[PE.scala:64:24, :69:15]
  ...
  MacUnit mac_unit (	// @[PE.scala:64:24]
    .io_in_a  (io_in_a),
    .io_in_b  (io_in_b),
    .io_in_c  (io_in_control_propagate ? c2 : c1),	// @[PE.scala:69:15, :70:15, :102:30, :106:24, :113:24]
    .io_out_d (_mac_unit_io_out_d)
  );
  assign io_out_a = io_in_a;
  assign io_out_b = io_in_b;
  assign io_out_c = io_in_control_propagate ? _io_out_c_T + {31'h0, (|shift_offset) & _io_out_c_point_five_T_3[0] & ((|(shift_offset < 5'h2 ? 32'h0 : c1 & (32'h1 << _GEN) - 32'h1)) | _io_out_c_T[0])} : _io_out_c_T_11 + {31'h0, (|shift_offset) & _io_out_c_point_five_T_8[0] & ((|(shift_offset < 5'h2 ? 32'h0 : c2 & (32'h1 << _GEN_1) - 32'h1)) | _io_out_c_T_11[0])};	// @[Arithmetic.scala:101:{32,50}, :102:{24,27,52,60,81,89}, :103:30, :105:{29,38}, :107:28, PE.scala:69:15, :70:15, :90:25, :102:30, :103:16, :110:16]
